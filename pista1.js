var pista1 = {
		...
		preload: function() {
			...
			game.load.tilemap('level', 'assets/supermario2.json', null, Phaser.Tilemap.TILED_JSON);
		...
		create: function() {
			...
			diamond = game.add.sprite(1040, game.world.height - 140,'diamond');
			...
			sword = game.add.sprite(900, game.world.height - 100,'sword');
			swords = game.add.group(); 
			sword.enableBody = true;
			game.physics.arcade.enable(sword);

			swords = game.add.sprite(1952, game.world.height - 80,'swords');
